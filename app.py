...
def fetch_weather_openmeteo(lat, lon):
    ...
    try:
        # TAMBAH parameter apparent_temperature untuk "Terasa Seperti"
        ...
        return {
            ...
            "feelslike_c": round(current["apparent_temperature"])  # ⭐ INI "TERASA SEPERTI"
        }
    except Exception as e:
...
def fetch_weather(lat=None, lon=None):
    try:
        ...
        print("⚠️ Using realistic Bangil data")
